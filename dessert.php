...
<body style="background-image: url(./images/food1.jpg); background-size: cover;">
    ...
    <h4>SELECT YOUR DESSERT</h4>
    <div class="div">
        <ul class="ul1">
                <div class="foods">
                    <p id="foodname2" class="foodname2">ICE CREAM</p>
                    <h6 id="price2" class="price2">50</h6>
                    <img class="foodimage" src="/images/icecream.jpg" alt="HTML5 Icon">
                    <div class="buttons">
            ...
            <li class="list">
                <div class="foods">
                    <p id="foodname3" class="foodname3">COOKIES</p>
                    <h6 id="price3" class="price3">30</h6>
                    <img class="foodimage" src="/images/cookies.jpg" alt="HTML5 Icon">
                    <div class="buttons">
            ...
            <li class="list">
                <div class="foods">
                    <p id="foodname4" class="foodname4">GELATIN</p>
                    <h6 id="price4" class="price4">40</h6>
                    <img class="foodimage" src="/images/gelatin.jpg" alt="HTML5 Icon">
                    <div class="buttons">
