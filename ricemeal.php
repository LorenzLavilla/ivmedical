...
<body style="background-image: url(./images/food1.jpg); background-size: cover;">
    ...
    <h4>SELECT YOUR RICE MEAL</h4>
    <div class="div">
        <ul class="ul1">

            <li class="list">
                <div class="foods">
                    <p id="foodname2" class="foodname2">CHICKEN CURRY</p>
                    <h6 id="price2" class="price2">150</h6>
                    <img class="foodimage" src="/images/chickencurry.jpg" alt="HTML5 Icon">
                    <div class="buttons">
                        ...
                        <script>
                            ...
                            var button3 = document.getElementById("insert-button2");
                            var button4 = document.getElementById("addbutton2");
            ...
            <li class="list">
                <div class="foods">
                    <p id="foodname3" class="foodname3">PORK CHOP</p>
                    <h6 id="price3" class="price3">150</h6>
                    <img class="foodimage" src="/images/porkchop.jpg" alt="HTML5 Icon">
                    <div class="buttons">
            ...
            <li class="list">
                <div class="foods">
                    <p id="foodname4" class="foodname4">PORK SISIG</p>
                    <h6 id="price4" class="price4">150</h6>
                    <img class="foodimage" src="/images/porksisig.jpg" alt="HTML5 Icon">
                    <div class="buttons">
